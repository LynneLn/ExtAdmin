...
Ext.define('Ext.field.Date', {
    ...
    config: {
         ...
         * Defaults to {@link #cfg!dateFormat}.
         * @since 7.0
         */
        submitFormat: null,
     ...
     * Returns the submit value for the datefield based on submitFormat which 
     * can be used when submitting forms.
     * @return {String} value If submitFormat, The value of {@link Ext.Date#format}
     * @since 7.0
     */
    getSubmitValue: function() {
        var me = this,
            format = me.getSubmitFormat() || me.getDateFormat(),
            value = me.getValue();
